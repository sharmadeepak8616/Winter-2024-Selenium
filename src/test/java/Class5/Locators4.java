...
public class Locators4 {
     ...
     * If you cannot each to any tag in unique way in the dom, try to reach to it's parent.
     *      If there is no unique way to reach to a parent, then try it's grandparent and so on...
     *
